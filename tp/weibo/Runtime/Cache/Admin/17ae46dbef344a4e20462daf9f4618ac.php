...
<div class="container">
	<ol class="breadcrumb">
		...
		<li class="active">再次编辑案例</li>
	</ol>
	<div class="well center-block" style="width:700px">
		<h3 class="text-center">再次编辑案例</h3>
		<form action="<?php echo U('examplechange');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
